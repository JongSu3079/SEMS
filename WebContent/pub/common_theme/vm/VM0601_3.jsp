						...
						<form id="inputForm" name="inputForm" action="#">
							...
							<fieldset>
								...
								<div class="form_row">
									...
									<div class="inputBox">
										<select id="scrSignOper" name="scrSignOper">
											...
											<option value="3" selected="selected">사용자 정의</option>
										</select>
										<input type="hidden" id="scrSignOperLog" name="scrSignOperLog" value="L0">
									</div>
								</div>
								<div class="form_row" id="signTime">
									<h3>ON/OFF 시간</h3>
									<div class="inputBox">
										<input type="text" id="signOn" name="signOn" value="08:00" style="width: calc(50% - 3px);">
										<input type="text" id="signOff" name="signOff" value="08:00" class="right" style="width: calc(50% - 3px);">
								...
								<div class="form_row" id="signDely" style="display:none">
									...
									<div class="inputBox">
										<input type="number" id="signOnDely" name="signOnDely" value="" style="width: calc(50% - 3px);">
										<input type="number" id="signOffDely" name="signOffDely" value="" class="right" style="width: calc(50% - 3px);">
