<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<div class="trunk">
		...
		<div id="container">
			...
			<!-- 메시지 리스트 -->
			<ul id="message_list" class="message_list type3">
				<li>
					...
					<div class="detail_area">
						<span class="detail">장비명 : FRY<br>
							장애일시 : 2018.06.20 00:38 ~ 2018.06.20 10:28<br>
							장애내용 : 25 OSC3 장비 저온 이상 (-9.3℃)
						</span>
						<em class="action">담당 A/S 기사가 [확인 후] 조치할 예정입니다.</em>
					</div>
				</li>
				<li>
					<div class="title_area">
					...
					<div class="detail_area">
						<span class="detail">장비명 : OSC<br>
							장애일시 : 2018.04.24 00:38 ~ 2018.05.07 15:28<br>
							장애내용 : 25 OSC1 장비 고온 이상 (21.5℃)
						</span>
						<em class="action">담당 A/S 기사가 [확인 후] 조치할 예정입니다.</em>
					</div>
				</li>
