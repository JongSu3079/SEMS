...
<style>
	#errorbox { margin:auto; text-align:center; vertical-align:middle;font-size:14px; }
	a{ text-decoration:none; color:gray; border:1px solid gray; padding:3px; }
</style>
</head>
<body>
...
<div id="errorbox">
	<br/><br/>
	<img src="${pageContext.request.contextPath}/images/stat/empty_icon.png"/>
	<br/>
	<h2>서버 점검중입니다.</h2>
	<br/>
	<p>(예상소요시간)</p>
	<p>2016.09.02 21:00 ~ 2016.09.03 02:00</p>
	<br/>
</div>
