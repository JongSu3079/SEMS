...
<link rel="icon" href="data:,">
	<script>
		...
		Rollbar.info('[' + statusCode + ']++++ 세션 만료 페이지 호출함 ++++');
	</script>

<title>잘못된 요청입니다.</title>
<link rel="stylesheet" type="text/css" href="/resources/${smCommonCssPath}/error.css?ver=${toDay}" />
<link rel="stylesheet" type="text/css" href="/${smCompanyCd}/lib/${smCompanyCssPath}/customer_error.css?ver=${toDay}" />
</head>
<body>
<div id="errorbox">
	<h2>세션이 만료되었습니다.</h2>
