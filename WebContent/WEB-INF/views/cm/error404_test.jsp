...
<!-- 	<link rel="icon" href="/resources/favico.ico" type="image/x-icon" /> -->
	...
	<script>
		...
		Rollbar.info('[' + statusCode + ']++++ 5분 대기 페이지 호출함 ++++');
	</script>
	...
	<style>
        ...
        .home-button {
            ...
            border-radius: 5px;
            cursor: pointer;
            transition: background-color 0.3s; /* 마우스 오버 시 스타일 변화를 부드럽게 만듭니다. */
        }
        .home-button:hover {
...
<div class="flexBox">
	...
	<h1>접속자가 많아 </h1>
	<h1>잠시 <span class="colorGreen">대기 중</span>입니다.</h1>
	<div class="spacer"></div>
	<h2>잠시 후 다시 시도해주세요.</h2>
	<div class="spacer"></div>
	<div class="custom-paper">
		<h3>예상 대기시간</h3>
		<p><span class="colorGreen">5분 미만</span></p>
	</div>
	<div class="spacer"></div>
	<button onclick="javascript:fnMoveLoginPage();" class="home-button">이전 페이지로 이동</button>
</div>
</body>
</html>
