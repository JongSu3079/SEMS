...
<html lang="ko">
<head>
<title>에너지 관제시스템 모바일웹 - 긴급공지</title>
...
<body>
				...
				<div id="header_sub">
					...
					<div class="toolbar">
						...
						<ul class="header_refesh_button">
							<li><a href="#" onclick="javascript:fn_VM2301refresh(); return false;" class="btn_refresh">새로고침</a></li>
						</ul>
						<!-- //새로고침 버튼영역 -->
	...
	<!-- viewJs import -->
	<script src="/resources/viewJs/vm/VM2301.js"></script>
	<!-- //viewJs import -->
