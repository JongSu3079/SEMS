			...
			<div id="header_sub">
				...
				<div class="toolbar">
					...
					<div class="icon_previous">
						<a href="javascript:fn_VM0702Redirect();" title="이전화면" class="btn_previous">이전화면</a>
					</div>
					<!-- //이전화면 아이콘 버튼 -->
						...
						<div class="info">
							...
							<div class="info_detail">
								<span>
									...
									<c:choose>
										<c:when test="${goDetailParamData.message2 == ''}">
											장애내용 : ${goDetailParamData.message}
										</c:when>
										<c:otherwise>
											장애내용 : ${goDetailParamData.message2}
										</c:otherwise>
									</c:choose>
								</span>
							</div>
...
<!-- 							<h3>알람 원인</h3> -->
<!-- 							<div class="inputBox"> -->
<!-- 								<select id="as_noteType" name="asNoteType" title="알람 원인"> -->
<!-- 									<option value="">선택</option> -->
<%-- 									<c:forEach var="item" items="${asNoteType}"> --%>
<%-- 										<option value="${item.commCd}">${item.commCdNm}</option> --%>
<%-- 									</c:forEach> --%>
<!-- 								</select> -->
<!-- 							</div> -->
<!-- 						</div> -->
						<div class="form_row">
							<h3>${bodyTxt}</h3>
							<div class="inputBox">
								<select id="as_type" name="asType" title="조치방법 상세" onchange="asTypeOnchange(this)">
									<option value="">선택</option>
							...
							<div id="asNoteArea" class="inputBox none">
								<textarea id="as_note" name="asNote" cols="5" rows="5" title="${bodyTxt} 직접입력" placeholder="조치내용 직접 입력"></textarea>
							</div>
						</div>
					</fieldset>
					<!-- //입력 폼 -->
				...
				<!-- 저장 버튼 영역 -->
				<div class="btn_save">
					<p><a href="#" onclick="fn_VM0702save(); return false;">저장</a></p>
				</div>
				<!-- //저장 버튼 영역 -->
			</div>
			<!-- //조치내역 영역 -->
	...
	<!-- viewJs import -->
	<script src="/resources/viewJs/vm/VM0702.js"></script>
	<!-- //viewJs import -->
</body>
</html>