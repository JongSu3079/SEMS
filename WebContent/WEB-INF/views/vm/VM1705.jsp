			...
			<div id="container">
				...
				<div class="setting_area">
					...
					<div class="list_text_detail type1 height-transition" style="max-height: 138px;">
						<div class="btn_grp">
							<div class="btn_act" id="saveBtn"><a href="" class="btn_single" onclick="fn_VM1705SaveBtn(); return false;" style="margin:4px 0 0 0">저장</a></div>
						</div>
					</div>
