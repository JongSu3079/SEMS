...
<body>
			...
			<div id="header_search">
				...
				<div class="toolbar">
					...
					<div class="icon_previous" >
						<a href="#" onClick="javascript:fn_VM2001Redirect();" title="이전화면" class="btn_previous" id="btn_previous" >이전화면</a>
					</div>
					<!-- //이전화면 아이콘 버튼 -->
				...
				<div class="search">
					<div class="search_box">
						...
						<input type="text" id="srcStrNm" name="srcStrNm" value="" maxlength="30" placeholder="점포명을 입력하세요." onkeypress="if(event.keyCode==13) {fn_VM2002Search(); return false;}"  />
						<a href="" onclick="fn_VM2002Search(); return false;" class="btn_search_1">조회</a>
					</div>
				</div>
				<!-- //검색 영역 -->
			</div>
		...
		<div id="container">
			...
			<div class="bottom_btn_group" id="bottom_btn_group">
				<p id="btn_more" class="btn_more" style="display:none;">
					<a href="#" onclick="fn_VM2002showMoreList(); return false;">더보기</a>
				</p>
	...
	<!-- viewJs import -->
	<script src="/resources/viewJs/vm/VM2002.js"></script>
	<!-- //viewJs import -->
</body>
</html>