...
<!-- 					<h3 class="inner">점검일정</h3> -->
				...
				<section>
					<div class="search_list">
						...
						<div id="authEx" class="tab">
							<a href="#" id="tab_1" onclick="fn_VM2001changeTab('S'); return false;" class="tab_on">처리예정</a>
							<a href="#" id="tab_2" onclick="fn_VM2001changeTab('Y'); return false;" class="tab_off">처리완료</a>
							<a href="#" id="tab_3" onclick="fn_VM2001changeTab('P'); return false;" class="tab_off">미결</a>
						</div>
						<!-- 탭영역 -->
						...
						<div class="bottom_btn_group" id="bottom_btn_group">
							<p id="btn_more" class="btn_more" style="display:none;">
								<a href="#" onclick="fn_VM2001showMoreList(); return false;">더보기</a>
							</p>
	...
	<!-- viewJs import -->
	<script src="/resources/viewJs/vm/VM2001.js"></script>
	<!-- //viewJs import -->
</body>
</html>