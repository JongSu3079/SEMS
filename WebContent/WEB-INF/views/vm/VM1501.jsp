...
<html lang="ko">
<head>
<title>에너지 관제시스템 모바일웹 - 장비 알람</title>
...
<body>
		...
		<div class="trunk">
				...
				<div id="header_search">
					...
					<div class="toolbar">
						...
						<ul class="header_refesh_button">
							<li><a href="#" onclick="javascript:fn_VM1501refresh(); return false;" class="btn_refresh">새로고침</a></li>
						</ul>
						<!-- //새로고침 버튼영역 -->
					...
					<div class="search">
						<div class="search_box">
							...
							<input type="text" id="qStrNm" name="qStrNm" value="${returnParam.qStrNm}" maxlength="30" placeholder="점포명을 입력하세요." onkeypress="if(event.keyCode==13) {fn_VM1501search(); return false;}" />
							<a href="" onclick="javascript:fn_VM1501search(); return false;" class="btn_search_1">조회</a>
						</div>
					</div>
					<!-- //검색 영역 -->
			...
			<div id="container">
				...
				<div id="authEx" class="tab">
					<a href="#" id="tabProcess" onclick="fn_VM1501changeTab('0',click); return false;" class="tab_on">미조치</a>
					<a href="#" id="tabRecovery" onclick="fn_VM1501changeTab('1',click); return false;" class="tab_off">복구</a>
					<a href="#" id="tabResult" onclick="fn_VM1501changeTab('2',click); return false;" class="tab_off">조치완료</a>
				</div>
				<!-- 탭영역 -->
	...
	<!-- viewJs import -->
	<script src="/resources/viewJs/vm/VM1501.js"></script>
	<!-- //viewJs import -->
</body>
</html>