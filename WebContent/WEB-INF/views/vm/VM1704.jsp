...
<body>
			...
			<div id="header_search">
				...
				<div class="toolbar">
					...
					<ul class="header_refesh_button">
						<li><a href="" class="btn_refresh" onclick="fn_VM1704refresh(); return false;">새로고침</a></li>
					</ul>
					<!-- //새로고침 버튼영역 -->
				...
				<div class="search">
					<div class="search_box">
						...
						<input type="text" id="srcStrNm" name="srcStrNm" value="${pageParam.strNm}" maxlength="30" placeholder="점포명/점포코드를 입력하세요." onkeypress="if(event.keyCode==13) {fn_VM1704refresh(); return false;}"  />
						<a href="" onclick="javascript:fn_VM1704refresh(); return false;" class="btn_search_1">조회</a>
					</div>
				</div>
				<!-- //검색 영역 -->
			</div>
		...
		<div id="container">
			...
			<div class="bottom_btn_group" id="bottom_btn_group">
				<p id="btn_more" class="btn_more" style="display:none;">
					<a href="#" onclick="fn_VM1704showMoreList(); return false;">더보기</a>
				</p>
	...
	<!-- viewJs import -->
	<script src="/resources/viewJs/vm/VM1704.js"></script>
	<!-- //viewJs import -->
</body>
</html>