			...
			<div id="header_sub">
				...
				<div class="toolbar">
					...
					<div class="icon_previous">
						<a href="javascript:fn_VM1701Redirect();" title="이전화면" class="btn_previous">이전화면</a>
					</div>
					<!-- //이전화면 아이콘 버튼 -->
...
<%-- 								<input id="strNm" name="strNm" type="text" value="${pageParam.strNm}" /> --%>
						...
						<div class="form_row">
							<h3>냉장비업체<span class="criticalItems">필수항목</span></h3>
							<div class="inputBox">
				...
				<div class="btn_grp">
					<div class="btn_act" >
						<a href="#" class="btn_save" id="checkBtn" 		onclick="javascript:fn_VM1703SaveAs(); return false;" style="margin: 25px 0 10px 10px;">접수</a>
					</div>
				</div>
				<!-- //버튼 영역 -->
			</div>
	...
	<!-- viewJs import -->
	<script src="/resources/viewJs/vm/VM1703.js"></script>
