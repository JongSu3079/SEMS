...
<body>
		...
		<div class="trunk">
			...
			<header>
				...
				<div id="header_search">
					...
					<div class="toolbar">
						...
						<!-- 새로고침 버튼영역 -->
						<ul class="header_new2_button" id="newSignAs" style="display: none">
							<li><a href="#" id="newAsClosing" onclick="javascript:fn_VM2101newAs();">신규작성</a></li>
						</ul>

						<ul class="header_refesh_button">
							<li><a href="#" onclick="javascript:fn_VM2101refresh();" class="btn_refresh">새로고침</a></li>
						</ul>
						<!-- //새로고침 버튼영역 -->
					...
					<div class="search">
						<div class="search_box">
							...
							<input type="text" id="qStrNm" name="qStrNm" value="${returnParam.qStrNm}" maxlength="30" placeholder="점포명을 입력하세요." onkeypress="if(event.keyCode==13) {fn_VM2101search(); return false;}" />
							<a href="#" onclick="javascript:fn_VM2101search();" class="btn_search_1">조회</a>
						</div>
					</div>
					<!-- //검색 영역 -->
			...
			<div id="container">
				...
				<div id="authEx" class="tab">
					<a href="#" id="tab_U" onclick="fn_VM2101SetTab('U'); return false;" class="tab_on">미확인</a>
					<a href="#" id="tab_S" onclick="fn_VM2101SetTab('S'); return false;" class="tab_off">예정</a>
					<a href="#" id="tab_Y" onclick="fn_VM2101SetTab('Y'); return false;" class="tab_off">처리완료</a>
					<a href="#" id="tab_P" onclick="fn_VM2101SetTab('P'); return false;" class="tab_off">미처리</a>
				</div>
				<!-- 탭영역 -->
				...
				<div class="bottom_btn_group" id="bottom_btn_group">
					<p id="btn_more" class="btn_more" style="display:none;">
						<a href="#" onclick="fn_VM2101showMoreList(); return false;">더보기</a>
					</p>
	...
	<!-- viewJs import -->
	<script src="/resources/viewJs/vm/VM2101.js"></script>
	<!-- //viewJs import -->
</body>
</html>